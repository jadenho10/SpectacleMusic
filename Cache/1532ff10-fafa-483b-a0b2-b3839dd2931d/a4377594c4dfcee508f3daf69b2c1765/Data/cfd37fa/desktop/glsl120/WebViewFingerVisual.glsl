...
float l9_2=max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),normalize(varNormal))),Port_Exponent_N003),0.0)*Port_Intensity_N003;
vec3 l9_3=mix(mix(baseColor,mix(vec3(dot(baseColor,vec3(0.29899999,0.58700001,0.114))),baseColor,vec3(Port_Amount_N009)),vec3(Port_Input0_N010-l9_2)),Port_Input1_N013,vec3(mix(Port_Input0_N014,Port_Input1_N014,trigger)));
float l9_4=l9_1.x/(Port_Input1_N020+1.234e-06);
float l9_5=atan(l9_1.y,l9_1.z)*Port_Input1_N034;
float l9_6=l9_0*Port_Multiplier_N019;
float l9_7=l9_0*Port_Multiplier_N028;
float l9_8=(l9_4-Port_Input1_N018)*(((sin((l9_5*Port_Input1_N024)+l9_6)*Port_Input1_N023)+(l9_4+Port_Input1_N027))*((sin((l9_5*Port_Input1_N036)+l9_7)*Port_Input1_N032)+(l9_4+Port_Input1_N031)));
float l9_9=min(max(l9_2,mix(Port_Input0_N011,Port_Input1_N011,trigger))*alpha,l9_8);
vec4 l9_10=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_10.w=l9_9;
if (l9_3.x<step(l9_8,Port_Input1_N035))
{
discard;
}
