...
//sampler sampler Tweak_N1SmpSC 2:17
...
//texture texture2D Tweak_N1 2:0:2:17
...
#endif
vec4 l9_30=sc_SampleTextureLevel(Tweak_N1Dims.xy,Tweak_N1Layout,l9_29,l9_28,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1),(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0),Tweak_N1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0),Tweak_N1BorderColor,0.0,Tweak_N1);
int l9_31;
...
#endif
vec4 l9_32=sc_SampleTextureLevel(baseTexDims.xy,baseTexLayout,l9_31,l9_28,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec3 l9_33=l9_32.xyz;
vec3 l9_34=l9_30.xyz-l9_33;
vec3 l9_35=vec3(l9_34.y,0.0-l9_34.x,0.0);
...
vec3 l9_38=l9_35*l9_37;
varPos=((mix(l9_38,l9_38*vec3(smoothstep(-1.0,(4.2199998+0.001)-0.001,clamp(((4.2199998+0.001)-0.001)-length(l9_35),0.0,(4.2199998+0.001)-0.001))),vec3(0.001-0.001))*vec3(l9_3.x+(-0.5)))*vec3(width*(cameraSize/20.000002)))+(l9_33+(l9_34*vec3(l9_3.y)));
varNormal=normalize(l9_27);
vec3 l9_39=normalize(varTangent.xyz);
...
{
vec4 l9_50=l9_43;
l9_50.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_43.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_43.w;
l9_49=l9_50;
}
#else
{
...
#endif
vec4 l9_28=outputMotionVectorsIfNeeded(varPos,max(l9_0,vec4(0.0)));
