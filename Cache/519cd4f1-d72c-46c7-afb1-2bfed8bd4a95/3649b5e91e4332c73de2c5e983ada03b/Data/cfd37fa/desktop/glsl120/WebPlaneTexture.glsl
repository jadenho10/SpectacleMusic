...
#endif
float l9_24=clamp(Port_Import_N045,0.0,1.0)*Port_Input1_N046;
int l9_25=sc_GetStereoViewIndex();
float l9_26=l9_24/(sc_ModelViewMatrixArray[l9_25][0].x+1.234e-06);
vec2 l9_27=abs(varPackedTex.xy-Port_Input1_N075);
float l9_28=l9_24/(sc_ModelViewMatrixArray[l9_25][1].y+1.234e-06);
float l9_29=l9_23.w*(smoothstep(Port_Input0_N078,Port_Input0_N073-min(gl_FragCoord.z*l9_26,l9_26),l9_27.x)*smoothstep(Port_Input0_N085,Port_Input0_N084-min(gl_FragCoord.z*l9_28,l9_28),l9_27.y));
vec4 l9_30=vec4(l9_23.x,l9_23.y,l9_23.z,vec4(0.0).w);
l9_30.w=l9_29;
