...
//float Port_Import_N042 4288
//float Port_Input0_N078 4292
//float Port_Input0_N073 4296
//float Port_Import_N045 4300
//float Port_Input1_N046 4304
//float2 Port_Input1_N075 4312
//float Port_Input0_N085 4320
//float Port_Input0_N084 4324
//float depthRef 4328
//}
...
float Port_Input0_N078;
float Port_Input0_N073;
float Port_Import_N045;
float Port_Input1_N046;
float2 Port_Input1_N075;
float Port_Input0_N085;
float Port_Input0_N084;
float depthRef;
};
struct sc_Bone_t
{
...
float2 UVCoord_N95=float2(0.0);
UVCoord_N95=Globals.Surface_UVCoord0;
...
Color_N98=l9_86;
float Value4_N2=0.0;
float4 param_11=Color_N98;
float param_12=param_11.w;
Value4_N2=param_12;
float Value_N42=0.0;
Value_N42=Value4_N2;
float Depth_N44=0.0;
float4 l9_87=gl_FragCoord;
float param_13=l9_87.z;
Depth_N44=param_13;
float Value_N45=0.0;
Value_N45=fast::clamp((*sc_set0.UserUniforms).Port_Import_N045,0.0,1.0);
float Output_N46=0.0;
Output_N46=Value_N45*(*sc_set0.UserUniforms).Port_Input1_N046;
float4x4 Matrix_N47=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
int l9_88=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_88=0;
...
int l9_89=l9_88;
Matrix_N47=(*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_89];
float4 Vector0_N48=float4(0.0);
float4 Vector1_N48=float4(0.0);
float4x4 param_14=Matrix_N47;
float4 param_15=param_14[0];
float4 param_16=param_14[1];
Vector0_N48=param_15;
Vector1_N48=param_16;
float Value1_N54=0.0;
float4 param_17=Vector0_N48;
float param_18=param_17.x;
Value1_N54=param_18;
float Output_N57=0.0;
Output_N57=Output_N46/(Value1_N54+1.234e-06);
float Output_N70=0.0;
Output_N70=Depth_N44*Output_N57;
float Output_N72=0.0;
Output_N72=fast::min(Output_N70,Output_N57);
float Output_N73=0.0;
Output_N73=(*sc_set0.UserUniforms).Port_Input0_N073-Output_N72;
float2 UVCoord_N74=float2(0.0);
UVCoord_N74=Globals.Surface_UVCoord0;
float2 Output_N75=float2(0.0);
Output_N75=UVCoord_N74-(*sc_set0.UserUniforms).Port_Input1_N075;
float2 Output_N76=float2(0.0);
Output_N76=abs(Output_N75);
float Value1_N77=0.0;
float Value2_N77=0.0;
float4 param_19=float4(Output_N76,0.0,0.0);
float param_20=param_19.x;
float param_21=param_19.y;
Value1_N77=param_20;
Value2_N77=param_21;
float Output_N78=0.0;
Output_N78=smoothstep((*sc_set0.UserUniforms).Port_Input0_N078,Output_N73,Value1_N77);
float Depth_N79=0.0;
float4 l9_90=gl_FragCoord;
float param_22=l9_90.z;
Depth_N79=param_22;
float Value2_N80=0.0;
float4 param_23=Vector1_N48;
float param_24=param_23.y;
Value2_N80=param_24;
float Output_N81=0.0;
Output_N81=Output_N46/(Value2_N80+1.234e-06);
float Output_N82=0.0;
Output_N82=Depth_N79*Output_N81;
float Output_N83=0.0;
Output_N83=fast::min(Output_N82,Output_N81);
float Output_N84=0.0;
Output_N84=(*sc_set0.UserUniforms).Port_Input0_N084-Output_N83;
float Output_N85=0.0;
Output_N85=smoothstep((*sc_set0.UserUniforms).Port_Input0_N085,Output_N84,Value2_N77);
float Output_N86=0.0;
Output_N86=Output_N78*Output_N85;
float Output_N87=0.0;
Output_N87=Value_N42*Output_N86;
float Export_N88=0.0;
Export_N88=Output_N87;
float4 Value_N1=float4(0.0);
Value_N1=float4(Color_N98.xyz.x,Color_N98.xyz.y,Color_N98.xyz.z,Value_N1.w);
Value_N1.w=Export_N88;
FinalColor=Value_N1;
...
float4 l9_95=fast::max(param_26,float4(0.0));
float4 param_27=l9_95;
if (sc_ShaderCacheConstant_tmp!=0)
{
